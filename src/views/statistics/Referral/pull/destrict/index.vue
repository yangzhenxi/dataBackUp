        ...
        <a-row :gutter="48">
          ...
          <a-col
            ...
            <a-form-item label="状态" >
              <a-select placeholder="请选择状态" allowClear v-model="queryParam.status" >
...
export default {
    ...
    data () {
        return {
            ...
            loadData: async (parameter) => {
                ...
                const result = deepGet(await GetReferralPullRes(this.queryParam), 'data', [])
                result.forEach((u, o) => {
    ...
    methods: {
        toDistrict (row) {
            this.$router.push({
                path: `/Statistics/Referral/upload/${row.code}`,
        ...
        ErrorLog (row) {
			...
			this.queryParam.router = 'Statistics/Referral/upload'
