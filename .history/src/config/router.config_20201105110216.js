                ...
                children: [
                    {
                        ...
                        children: [
                            {
                                path: '/Statistics/Home/District',
                                name: 'District',
                                // hidden: true,
                                component: () => import('@/views/Statistics/Home/District'),
                                meta: { title: '区县机构', hideChildrenInMenu: false, keepAlive: false, permission: ['dashboard'] }
                            }
                        ]
                    },
                    {
