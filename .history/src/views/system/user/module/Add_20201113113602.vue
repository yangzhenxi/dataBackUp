    ...
    <a-spin :spinning="loading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          <a-input-password
            placeholder="请输入用户名"
            v-decorator="['password', { rules: [{required: true, message: '请输入用户名！'},{max:20,min:5,message:' 用户名长度为5-20个字符以内!'},{validator}],firstFields:true
            }]" />
        </a-form-item>
        <a-form-item
          label="角色"
