...
export default {
  ...
  data () {
    ...
    return {
      ...
      districtList: [
        { code: '33', town: '浙江省(其他)' },
        { code: '3303', town: '浙江省(其他)' },
        { code: '330301', town: '浙江省(其他)' },
        { code: '330302', town: '浙江省(其他)' },
        { code: '330303', town: '浙江省(其他)' },
        { code: '330304', town: '浙江省(其他)' },
        { code: '330322', town: '浙江省(其他)' },
        { code: '330324', town: '浙江省(其他)' },
        { code: '330326', town: '浙江省(其他)' },
        { code: '330328', town: '浙江省(其他)' },
        { code: '330329', town: '浙江省(其他)' },
        { code: '330381', town: '浙江省(其他)' },
        { code: '330382', town: '浙江省(其他)' },
        { code: '330399', town: '浙江省(其他)' }
      ],
