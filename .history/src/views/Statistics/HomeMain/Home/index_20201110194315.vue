...
// document.querySelectorAll('.btn').forEach(u => {
//     u.addEventListener('click', (record) => {
//         console.log(1)
//     })
// })
      ...
      columns: [
        {
          ...
          customRender: (val, row, index) => {
            ...
            //   attrs: {}
            // }
            // const rowSpan = this.getRowSpanCount(this.District, index)
            return {
                children: <a-button type="primary" size="small" class="btn" onclick="console.log(1)">{row.District}</a-button>,
                attrs: {
